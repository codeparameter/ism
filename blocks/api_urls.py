...
urlpatterns = [
    ...
    path('videos/', api_views.BlockVidListCreateAPIView.as_view()),
    path('videos/<int:pk>', api_views.BlockVidDetailAPIView.as_view()),
    path('videos/<int:pk>/update/', api_views.BlockVidUpdateAPIView.as_view()),
    path('videos/<int:pk>/delete', api_views.BlockVidDestroyAPIView.as_view()),
